...
const fixIntelI9 = async () => {
  try {
    ...
    // Complete specifications for Intel Core i9-13900K (no dots in keys)
    const detailedSpecs = {
      'Name': 'Intel Core i9-13900K',
      'Socket': 'LGA 1700',
      'CPU Cores': '24 (8P + 16E)',
    ...
    console.error('❌ Error fixing Intel Core i9-13900K:', error);
  }
};

const main = async () => {
  console.log('🚀 Fixing Intel Core i9-13900K specifications...\n');
