...
const fixMSIMotherboard = async () => {
  try {
    ...
    // Complete specifications for MSI B650 Tomahawk (no dots in keys)
    const detailedSpecs = {
      'Name': 'MSI B650 Tomahawk',
      'Socket': 'Socket AM5',
      ...
      'IO Shield': 'Pre-installed I/O Shield',
    ...
    console.error('❌ Error fixing MSI B650 Tomahawk:', error);
  }
};

const main = async () => {
  console.log('🚀 Fixing MSI B650 Tomahawk specifications...\n');
