...
const updateNZXTCase = async () => {
  try {
    ...
    // Complete specifications for NZXT H7 Flow
    const detailedSpecs = {
      'Name': 'NZXT H7 Flow',
      ...
      'Drive Bays 3.5 inch': '2',
      'Drive Bays 2.5 inch': '4',
    ...
    console.error('❌ Error updating NZXT H7 Flow:', error);
  }
};

const main = async () => {
  console.log('🚀 Updating NZXT H7 Flow...\n');
