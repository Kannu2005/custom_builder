...
const updateIntelI9 = async () => {
  try {
    ...
    // Complete specifications for Intel Core i9-13900K
    const detailedSpecs = {
      'Name': 'Intel Core i9-13900K',
      'Socket': 'LGA 1700',
      'CPU Cores': '24 (8P + 16E)',
      ...
      'PCIe 5.0 Support': 'Yes (16 lanes)',
      'PCIe 4.0 Support': 'Yes (4 lanes)',
      'Thunderbolt 4 Support': 'Via Chipset',
      'WiFi 6E Support': 'Via Chipset',
      'USB 3.2 Support': 'Via Chipset',
    ...
    console.log('   Max Boost:', detailedSpecs['Max Boost Clock P-Core']);
    ...
    console.error('❌ Error updating Intel Core i9-13900K:', error);
  }
};

const main = async () => {
  console.log('🚀 Updating Intel Core i9-13900K...\n');
